...
const Toast: React.FC<ToastProps> = ({
  ...
  return (
    <div
      className={`fixed pointer-events-auto z-50 ${positionClasses} max-w-sm w-full shadow-lg rounded-lg border-l-4 ${styles.border} ${styles.bg} overflow-hidden transform transition-all duration-300`}
      role="alert"
      aria-live="assertive"
      aria-atomic="true"
    >
      <div className="relative rounded-lg shadow-xs overflow-hidden">
        <div className="p-4">
