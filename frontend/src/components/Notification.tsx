...
const Notification: React.FC<NotificationProps> = ({
  ...
  return (
    <div className={`max-w-md w-full rounded-lg shadow-lg border-l-4 ${styles.container} overflow-hidden pointer-events-auto`}>
      <div className="p-4">
        <div className="flex items-start">
          ...
          <div className="ml-3 w-0 flex-1 pt-0.5">
            <p className={`text-sm font-medium ${styles.title}`}>{message}</p>
            {description && (
